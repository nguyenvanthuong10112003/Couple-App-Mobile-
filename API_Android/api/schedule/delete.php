...
if (!isset($_POST[ScheduleAttr::id[KeyTable::name]])) {
...
if ($schedule->senderId != $currentUser->id) {
    echo json_encode(new RequestAPI(RequestAPI::$ERROR, "Lời mời này không phải do bạn tạo", null), JSON_UNESCAPED_UNICODE);
    exit(0);
}
