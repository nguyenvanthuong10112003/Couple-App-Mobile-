...
public class HomeDetailUserActivityPage extends BasePageAuthActivity {
    ...
    private void setupContentView() {
        ...
        textLifeStory.setText(user.getLifeStory() != null && !user.getLifeStory().trim().isEmpty() ?
            user.getLifeStory() : "Chưa viết tiểu sử");
